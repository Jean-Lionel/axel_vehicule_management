        ...
        <div class="titlebar">
            ...
            <form action="{{route('entretien.index')}}">
                <div class="row ml-1">
                    ...
                    <h2 class="col-md-1"></h2>
                    <a href="{{route('entretien.create')}}" class="btn btn-sm btn-success col-md-1"><i class="bi bi-plus-lg"></i>&nbsp;Nouveau</a>
                </div>
            </form>
        </div>
        <div class="card mt-4">
                ...
                <tbody>
                    @foreach ($entretiens as $index=> $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('entretien.show',$item)}}" class="btn btn-sm btn-primary"><i class="bi bi-eye"></i></a>
                                <a href="{{route('entretien.edit',$item)}}" class="btn btn-sm btn-warning"><i class="bi bi-pen"></i></a>
