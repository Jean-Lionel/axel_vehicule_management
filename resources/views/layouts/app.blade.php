...
<body>
    <aside class="sidebar">
        ...
        <div class="side-inner">
            ...
            <div class="nav-menu">
                <ul>
                    <li class="active"><a href="{{route('vehicule.index')}}" class="d-flex align-items-center"><span class="wrap-icon icon-home2 mr-3"></span><span class="menu-text">Vehicule</span></a></li>
                    <li><a href="{{route('entretien.index')}}" class="d-flex align-items-center"><span class="wrap-icon icon-videocam mr-3"></span><span class="menu-text">Entretien</span></a></li>
                    <li><a href="{{route('depense.index')}}" class="d-flex align-items-center"><span class="wrap-icon icon-book mr-3"></span><span class="menu-text">Depenses</span></a></li>
                    <li><a href="{{route('carburant.index')}}" class="d-flex align-items-center"><span class="wrap-icon icon-shopping-cart mr-3"></span><span class="menu-text">Carburant</span></a></li>
                    <li><a href="{{route('maintenance.index')}}" class="d-flex align-items-center"><span class="wrap-icon icon-pie-chart mr-3"></span><span class="menu-text">Maintenance</span></a></li>
