...
@section('content')
    <div class="container">
        <div class="titlebar ">
            <div class="row">
                <h4 class="mb-3">Creer Carburant</h4>
            ...
            <form action="{{ route('carburant.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="form-outline col-6 mb-4">
                        ...
                        <input type="number" name="littre" id="littre" class="form-control" />
                        @error('littre')
                            <span class="text text-danger mt-2 text text-center">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="form-outline mb-4 col-6">
                        ...
                        <input type="text" name="price_per_littre" id="price_per_littre" class="form-control" />
